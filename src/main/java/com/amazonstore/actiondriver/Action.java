...
import com.amazonstore.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
    ...
    public boolean switchToFrameByIndex(WebDriver driver, int index) {
        ...
        try {
            ...
            new WebDriverWait(driver, timeoutDuration).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(index));
            flag = true;
            return true;
        } catch (Exception e) {
            return false;
